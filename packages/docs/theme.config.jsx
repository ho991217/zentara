...
export default {
  ...
  logoLink: '/en',
  docsRepositoryBase:
    'https://github.com/ho991217/zentara/tree/main/packages/docs',
  i18n: [
  ...
  project: {
    link: 'https://github.com/ho991217/zentara',
    icon: (
      <svg width='24' height='24' fill='currentColor' viewBox='0 0 98 96'>
        <title>GitHub</title>
        <path
          fill-rule='evenodd'
          clip-rule='evenodd'
